		...
		<tr>
			<td>
				<select name=\"permission\" onChange=\"javascript: document.fselperm.submit()\">
					<option value=\"1\"".$selected[0].">"._AM_ANIMAL_PERMISSIONS_ACCESS."</option>
					<option value=\"2\"".$selected[1].">"._AM_ANIMAL_PERMISSIONS_SUBMIT."</option>
					<option value=\"3\"".$selected[2].">"._AM_ANIMAL_PERMISSIONS_VIEW."</option>
				</select>
			</td>
		</tr>
	</table>
...
$module_id = $xoopsModule->getVar("mid");
	...
	{
		case 1:
			$formTitle = _AM_ANIMAL_PERMISSIONS_ACCESS;
			$permName = "xdirectory_access";
			$permDesc = "";
			break;
		case 2:
			$formTitle = _AM_ANIMAL_PERMISSIONS_SUBMIT;
			$permName = "xdirectory_submit";
			$permDesc = "";
			break;
		case 3:
			$formTitle = _AM_ANIMAL_PERMISSIONS_VIEW;
...
//	$xdir_cat_Handler=& xoops_getModuleHandler('xdirectory_xdir_cat', 'xdirectory' );
