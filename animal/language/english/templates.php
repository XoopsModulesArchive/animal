...
define("_PED_DELETE_PED","Delete pedigree's");
define("_PED_DAT_TOOLS","Database tools");
define("_PED_CREDITS","Credits");
define("_PED_TXT_COLOR","Text colour:");
define("_PED_LINK_COLOR","Link colour:");
define("_PED_BACK2_COLOR","Body background colour:");
define("_PED_BACK1_COLOR","Pedigree background colour:");
define("_PED_YES","Yes");
define("_PED_NO","No");
//tools submenu
define("_PED_ANCESTORS","Own ancestors");
define("_PED_USERQUERIES","User queries");
define("_PED_NOGENDER","Incorrect gender");
//tolls general setting
define("_PED_BLOCK_SETTING","General settings");
define("_PED_RESULT","Number of results per page");
define("_PED_SHOW_WELC","Show welcome screen ?");
define("_PED_BREED_FIELD","Use Owner/Breeder fields");
define("_PED_SHOW_BROT","Show brothers &amp; sisters");
define("_PED_USE_LITTER","Use add a litter feature");
define("PED_SHOW_KITT_A","Show");
define("_PED_SHOW_KITT_B","field");
define("_PED_SHOW_PICT","Show the image in the last row of the pedigree ? (great grandparents)");
//tools functions
define("_PED_CHECKED","Checked");
//tools modules parameters
define("_PED_BLOCK_NAME","Options module");
define("_PED_TYPE_AN","Animal type");
define("_PED_MALE","male");
define("_PED_FEMALE","female");
define("_PED_CHILDREN","Children");
define("_PED_FATHER","father");
define("_PED_MOTHER","mother");
define("_PED_LITTER","Litter");
define("_PED_WELC_TEXT","welcome text");
//tools create fields
define("_PED_ENTER_FIELD","Enter the fieldname");
define("_PED_NEXT_BUTTON","Next");
define("_PED_PREVIOUS_BUTTON","Previous");
define("_PED_FINISH_BUTTON","Finish");
define("_PED_SUBMIT_BUTTON","Submit");
define("_PED_FIELD_FORM1","<table><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Field</td><td>List</td><td>Search</td><td>Lookupfield</td></tr>");
define("_PED_FIELD_FORM2","<table><tr><td width=25%>Field name:</td><td width=50%>");
...
define("_PED_FIELDPICT","Picture");
define("_PED_FIELD_DEFAUT","Enter a default value for this field");
define("_PED_FIELDCONFIRM","Confirm the settings for this field");
define("_PED_DATEFIELD","Date field (Automatically displays a date picker)");
define("_PED_URLFIELD","Url field (Stores an url)");
define("_PED_TEXTAREAFIELD","Textarea (Multiple lines)");
define("_PED_TEXTBOXFIELD","textbox");
define("_PED_DROPDOWNFIELD","Dropdown list");
define("_PED_FIELDSEARCH","Field can be searched");
define("_PED_SHOWFIELD","Field will be shown in the pedigree");
define("_PED_SHOWFIELD_ADVANCE","Field will be shown in advanced information");
define("_PED_SHOWFIELD_PIECHART","Field will be shown as a pie chart");
define("_PED_SHOWFIELD_RESULT","Field will be shown in result list");
define("_PED_SHOWFIELD_ADDLITTER","Field can be added for each animal in the 'Add a litter' page");
define("_PED_SHOWFIELD_ADDLITTGLOBAL","Field can be added for the entire litter; not for each individual animal");
define("_PED_FIELDVALUE","Defaut value : ");
define("_PED_FIELDCONTROL1","Please verify the entered details below and then click 'Finish' to change your field properties.");
define("_PED_FIELDCONTROL2","Please verify the entered details below and then click 'Finish' to create your field..");
define("_PED_FIELDCONTROL3","<hr><i>You may change these settings at any time</i>");
define("_PED_FIELDCONTROL4","<hr>Fieldname : <b>");
define("_PED_FIELDCONTROL5","Field explanation : <b>");
define("_PED_FIELDCONTROL6","Field type : <b>");
define("_PED_FIELDCONTROL7","Defaut value : <b>");
define("_PED_SEARCH_NAME","Search name : <b>");
define("_PED_FIELDEXPLANSEARCH","<tr><td>Search explanation:</td><td>");
define("_PED_SYNTH1","Field will be shown in the pedigree : <b>YES</b><br />");
define("_PED_SYNTH2","Field will be shown on the advanced information page : <b>YES</b><br />");
define("_PED_SYNTH3","Field will be shown as a pie chart : <b>YES</b><br />");
define("_PED_SYNTH4","Field will be shown in search result list : <b>YES</b><br />");
define("_PED_SYNTH5","Field will be shown for each individual animal in the add a litter page : <b>YES</b><br />");
define("_PED_SYNTH6","Field will be shown once for all animals n the add a litter page : <b>YES</b><br />");


//tools explanation
define("_PED_BGCOLOR","Use the fields below to change the colours of the pedigree database. We advice choosing a very light colour for the \"Pedigree background color\"");
define("_PED_ANCEST_EXPLAN","For your pedigree database to work well it is important that the information contained within is correct.<br />It is possible create errors and achieve unexpected results by accidentily adding the wrong parents to an animal. If an animal is selected to be it's own parent or grandparent in infinite loop will be created when trying to view the pedigree. <br /><br />The database has been searched and any animals below the line require your attention.");
define("_PED_GENDER_EXPLAN","For your pedigree database to work well it is important that the information contained within is correct.<br />It is possible create errors and achieve unexpected results by changing the gender of an animal. If you discover that a male in the database is really female or the other way around it is possible to create errors if accidentilly children have been connected to the wrong gender.<br /><br />The database has been searched and any animals below the line require your attention.");
define("_PED_QUERIE_EXPLAN","Shown below are your personal queries.<br/>To request a user query use the form at <a href =\"http://www.animalpedigree.com\">AnimalPedigree.com</a>");
define("_PED_LOOKUPFIELD","Shown below are the user values for this lookupfield.<br />Click on the value to edit it.<br />Click on the 'X' to delete the value from the lookuptable.");
...
define("_PED_OWN_EXPLAIN","Use this field to set if you would like to use the owner/breeder fields of the database.As the name suggests the owner/breeder fields let you record and display information about the owner and or breeder.The owner/breeder menu items will also be affected by this setting.");
define("_PED_BROT_EXPLAIN","Use this field to set if you would like to use the add a litter feature.If your chosen animal only has one offspring at a time this feature will not be useful to you");
define("_PED_USE_LITTER_EXPLAIN","Use this field to set if you would like to display the brothers & sisters field on the detailed animal information page. ");
define("_PED_KITT_EXPLAIN","Use this field to set if you would like to display this field on the detailed information page.");
define("_PED_PICT_EXPLAIN","A pedigree can become very long and hard to fit on the screen if all the images are set for all animals in the pedigree. Using this setting you can switch off showing the images for the last row of the pedigree (great grandparents).<br /><i>Note: this only applies to the standard image of an animal. If you define additional picture fields they will be shown.</i>'");
define("_PED_SEARCH_FORM",".In the search form, select the first letter of the ");
define("_PED_FIELD_EXPLAIN","'Use this field to set the animal type which will be used in the application.<br /><i>example :snake, pigeon, dog, owl </i><br />The value should fit in the sentences below.<br />Please add optional information for this ");
define("_PED_FIELD_EXPLAIN2","Use this field to set the animal type which will be used in the application.<br />This field is the plural of the previous field<br /><i>example : snakes, pigeons, dogs, owls</i><br /><br />The value should fit in the sentence below.<br />No ");
define("_PED_FIELD_EXPLAIN3"," meeting your query have been found.");
define("_PED_MALE_EXPLAIN","Use this field to set the name used for the female animal.<br /><i>example: male, buck, sire etc.</i>");
define("_PED_FEMALE_EXPLAIN","Use this field to set the name used for the female animal.<br /><i>example: female, vixen, dam etc.</i>");
define("_PED_KITTEN_EXPLAIN1","Use this field to set the name used for the babies. Defaut:<b> ");
define("_PED_KITTEN_EXPLAIN2","</b><br/><i>Example: babies, kittens, pups etc. </i>");
define("_PED_FATHER1","Use this field to set the name used for father of this type of animal. Defaut:<b> ");
define("_PED_FATHER2","</b><br/><i>Example: father, stallion, etc.</i>");
define("_PED_MOTHER1","Use this field to set the name used for mother of this type of animal. Defaut:<b> ");
define("_PED_MOTHER2","</b><br/><i>Example: mare, dam, etc.</i>");
define("_PED_LITTER1","Use this field to set the name used for a collection of newborn animals.<br/><i>Example: litter, nest etc.</i>");
define("_PED_WELC_TXT_EXPLAIN","Use this field to set the text you would like to display for the welcome page.<br /><br />You may use the following variables :</br>[animalType]= ");
define("_PED_WELC_TXT_EXPLAIN2","<br/>[numanimals] = number of animals in the database.");
...
define("_PED_SEARCHNAME_EX", "Here you can search for specific [animalTypes] by entering (part of) a name.<br><br>Searching for part of a name (a few letters) will find all [animalTypes] with those letters anywhere in the name.<br>Searching for <b>a</b> will not find [animalTypes] with <b>á</b> or other special characters.");
...
define("_PED_COI_SSDEX", "Shown here are the statistics for the [father] and [mother] for the selected [animalType] or selected mating.<br><br>Coefficient of Relationship between [father] and [mother] is the amount of relationship between the pedigrees of the parents.<br>Also shown are the inbred percentages of both the [father] and [mother].");
