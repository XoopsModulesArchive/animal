...
if($fld == "nl" || $fld == "all")
{
	$form->addElement(new XoopsFormText("<b>"._PED_OWN_LNAME."</b>", 'naaml', $size=50, $maxsize=255, $value=$naaml));
...
{
	$form->addElement(new XoopsFormLabel(_PED_FLD_LNAME, $naaml));
}
//name first
if($fld == "nf" || $fld == "all")
{
...
{
	$form->addElement(new XoopsFormLabel(_PED_FLD_FNAME, $naamf));
}
//street
if($fld == "st" || $fld == "all")
{
